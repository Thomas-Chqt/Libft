...
/*   Updated: 2023/07/27 15:12:48 by tchoquet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*dic_get(t_dictionary dict, void *key, t_bool (*is_key_equal)(void *, void *))
{
	...
	found_lst_node = (t_list_dict *)lst_chr((t_list *)dict_int->vals[hashed_key], &is_equal_wapper, (void *[2]){key, is_key_equal});
